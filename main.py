...
df['img1'] = df['images'].apply(lambda x: make_image(x[0], 'image') if x else None)
...
df = df[df['driving_time'] < datetime.timedelta(hours=8)]
...
# "output.html", 
os.system("xdg-open out/output.html")
